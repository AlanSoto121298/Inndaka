            ...
            <div class="col-datos-personales">
                ...
                <div id="col-Fecha-Nss">
                    ...
                    <div class="input-with-label">
                        ...
                        <input type="text" placeholder="No.Infonavit" name="no_infonavit" id="col_Input_no_infonavit" required>
                    </div>
                    <div class="input-with-label">
                ...
                <div id="col-Tel-Cuenta">
                  ...
                  <div class="input-with-label">
                    ...
                    <div class="input-with-label">
                        ...
                        <input type="text" placeholder="No.Cuenta" name="no_cuenta" id="col-Input-Cuenta" required>
                    </div>
                ...
                <div id="col-Estado-Tipo-Sangre">
                    <div class="input-with-label">
                        ...
                        <input list="col-Estado-List" id="col-Input-Estado-Civil" name="estado_civil"
                    ...
                    <div class="input-with-label">
                        ...
                        <input list="col-Licencia-list" id="col-Input-Licencia-Conducir" name="licencia_conducir"
                    ...
                    <div class="input-with-label">
                        ...
                        <input list="col-Certificado" placeholder="Certificado Médico" name="certificado_medico"
                    ...
                    <div class="input-with-label">
                        ...
                        <input list="col-Tipo-De-Sangre-List" id="col-Input-Tipo-Sangre" name="tipo_sangre"
                        placeholder="Tipo de sangre" required>
                    </div>
                </div>
  <div class="col-Input-File">
        <input type="file" id="fileInput" name="archivo" accept=".jpg, .png, .pdf, .doc, .docx, .xls, .xlsx" onchange="changeImage(event)">
        <input type="hidden" id="foto_actual" name="foto_actual" value="<?php echo isset($_POST['foto_actual']) ? $_POST['foto_actual'] : ''; ?>">
        <div class="Col-image-container">
            ...
            <!-- START DIV QUE CONTIENE LA DOCUMENTACION INE Y LICENCIA -->
            <div class="col-Div-Documentacion">
    <div class="documento-container">
        <label for="ine">INE:</label>
        <div class="custom-file-upload">
            <input type="file" name="ine" id="ine" class="inputfile">
            <label for="ine" class="file-upload-button">Seleccionar Archivo</label>
        </div>
        <div class="documento-preview" id="preview-ine"></div>
        <div id="ine-adjunto" class="documentos-adjuntos"></div>
    </div>
    
    <div class="documento-container">
        <label for="licencia">Licencia:</label>
        <div class="custom-file-upload">
            <input type="file" name="licencia" id="licencia" class="inputfile">
            <label for="licencia" class="file-upload-button">Seleccionar Archivo</label>
        </div>
        <div class="documento-preview" id="preview-licencia"></div>
        <div id="licencia-adjunto" class="documentos-adjuntos"></div>
    </div>
</div>


            <!-- END DIV QUE CONTIENE LA DOCUMENTACION INE Y LICENCIA -->
            ...
            <div class="col-Div-Direccion">
                ...
                <div class="input-with-label">
                    ...
                    <input type="text" placeholder="Calle  y Número " name="calle_numero" id="col-Input-Calle-Numero"
                    required>
                </div>
                <div class="input-with-label">
            ...
            <div class="col-Div-Datos-Laborales">
                ...
                <div class="col-Div-Datos-Lab-2">
                    <div class="input-with-label">
                        ...
                        <input type="text" placeholder="Telefono empresarial" name="telefono_empresarial"
                        id="col-Input-Telefono-Empresarial" required>
                    </div>
                    <div class="input-with-label">
                        <label for="col-Input-Correo-Empresarial">Correo empresarial</label>
                        <input type="text" placeholder="Correo empresarial" name="correo_empresarial"
                    ...
                    <div class="input-with-label">
                        ...
                        <input type="text" placeholder="Salario Mensual" name="salario_mensual"
                ...
                <div class="col-Div-Datos-Lab-3">
                    <div class="input-with-label">
                        ...
                        <input type="date" placeholder=" " name="fecha_firma_inicial"
                    ...
                    <div class="input-with-label">
                        ...
                        <input type="date" placeholder=" " name="fecha_firma_final" id="col-Input-Fecha-Firma-Final">
                    </div>
                    <div class="input-with-label">
                        <label for="col-Input-Correo-Motivo-Baja">Motivo de baja</label>
                        <input type="text" placeholder="Motivo de baja" name="motivo_baja" id="col-Input-Correo-Motivo-Baja">
                    </div>
                </div>
            ...
            <input class="submit" type="submit" value="Guardar para historial" name="guardar" id="submitGuardar">
            <input class="submit" type="submit" value="Actualizar" name="actualizar" id="submitActualizar">
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    if (datosString) {
        ...
        document.getElementById("id_formulario").value = datos.id;
        ...
        // Muestra y descarga de documentos adjuntos
        if (datos.ine_path) {
            mostrarDocumentoAdjunto('INE', datos.ine_path, 'preview-ine');
        }
        if (datos.licencia_path) {
            mostrarDocumentoAdjunto('Licencia', datos.licencia_path, 'preview-licencia');
        }
    }
});

function mostrarDocumentoAdjunto(tipo, rutaArchivo, contenedorId) {
    const documentoPreview = document.getElementById(contenedorId);
    const fileExtension = rutaArchivo.split('.').pop().toLowerCase();
    if (fileExtension === 'pdf') {
        ...
        iframe.width = '100%';
        iframe.height = '450px';
        documentoPreview.appendChild(iframe);
    } else {
        // Mostrar una imagen previa o un enlace de descarga
        const imagen = document.createElement('img');
        imagen.src = rutaArchivo;
        imagen.alt = tipo;
        documentoPreview.appendChild(imagen);
    }
}
...
document.addEventListener("DOMContentLoaded", function () {
            ...
            if (datosString) {
                ...
                document.getElementById("col-Input-Masculino").checked = datos.sexo === "Masculino";
                document.getElementById("col-Input-Mujer").checked = datos.sexo === "Femenino";
                document.getElementById("preview-ine").value = datos.ine;
        ...
        function imprimirDatos() {
            ...
            const datos = {
                ...
                ine: document.getElementById("preview-ine").value = datos.ine,
