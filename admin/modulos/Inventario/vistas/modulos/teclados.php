        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                ...
                <!--                 <ol class="breakcrumb float-sm-right">
                    ...
                    <li class="breakcrumb-item active">Gestor Teclados</li>
...
<section class="content">
    ...
    <div class="container-fluid">
        ...
        <div class="btn-agregar-Teclados btnAgregar">
            <button type="button" class="btn btn-info btn-sm mb-4" data-toggle="modal" data-target="#modal-actualizar-Teclados" data-dismiss="modal">
                <i class="fas fa-plus-square"> Agregar Teclados</i>
            </button>
        </div>

        <table id="tablaTeclados" class="table table-striped table-bordered nowrap" style="width:100%;">
...
<div class="modal fade" id="modal-actualizar-Teclados">
    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h4 class="modal-title big-info">Gestionar Teclados</h4>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="form-group">
                            <input type="hidden" id="idteclados" name="idteclados" value="">
...
<script>
    $(document).ready(function() {
        ...
        var table = $("#tablaTeclados").DataTable({
            "ajax": {
                "url": "ajax/teclados.ajax.php",
                "type": "POST",
                "dataSrc": ""
            },
            "columnDefs": [{
        ...
        $('.btn-agregar-Teclados').on('click', function() {
            accion = "registrar";
        });

        $('#tablaTeclados tbody').on('click', '.btnEliminar', function() {
            var data = table.row($(this).parents('tr')).data();

            var idteclados = data["idteclados"];

            var datos = new FormData();
            datos.append('accion', 'eliminar');
            datos.append('idteclados', idteclados);

            swal.fire({
                title: "¡CONFIRMAR!",
                text: "Estás seguro que deseas eliminar el teclado?",
                icon: 'warning',
        ...
        $('#tablaTeclados tbody').on('click', '.btnEditar', function() {
            var data = table.row($(this).parents('tr')).data();
            accion = "actualizar";

            $('#idteclados').val(data["idteclados"]);
            $('#txtsku').val(data["sku"]);
            ...
            $('#modal-actualizar-Teclados').modal('show');
        });

        $('#modal-actualizar-Teclados').on('hidden.bs.modal', function() {
            $('#idteclados').val("");
            $('#txtsku').val("");
            $('#txtresponsable').val("");
        ...
        $('#btnGuardar').on('click', function() {
            ...
            swal.fire({
                title: "¡CONFIRMAR!",
                text: "Estás seguro que deseas registrar el teclado?",
                icon: 'warning',
                showCancelButton: true,
                ...
                if (resultado.value) {
                    ...
                    $.ajax({
                        ...
                        success: function(respuesta) {
                            ...
                            $("#modal-actualizar-Teclados").modal('hide');
