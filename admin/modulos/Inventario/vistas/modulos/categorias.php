        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                ...
                <!--                 <ol class="breakcrumb float-sm-right">
                    ...
                    <li class="breakcrumb-item active">Gestor Categorias</li>
...
<section class="content">
    ...
    <div class="container-fluid">
        ...
        <div class="btn-agregar-categorias btnAgregar">
            <button type="button" class="btn btn-info btn-sm mb-4" data-toggle="modal" data-target="#modal-actualizar-categoria" data-dismiss="modal">
                <i class="fas fa-plus-square"> Agregar Categorias</i>
            </button>
        </div>
...
<div class="modal fade" id="modal-actualizar-categoria">
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="categoria" id="txtcategoria" placeholder="Ingrese la categoria">
                        </div>
                    </div>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="ruta" id="txtRuta" placeholder="Ingrese la ruta">
                        </div>
                    </div>
...
<script>
    $(document).ready(function() {
        ...
        var table = $("#tablaCategorias").DataTable({
            ...
            "columnDefs": [{
                    "targets": 4, // Indica la posición de la columna "Estado" en base cero
                    "sortable": false,
                ...
                {
                    "targets": 5, // Indica la posición de la columna "Acciones" en base cero
                    "sortable": false,
                    "render": function(data, type, full, meta) {
                        return "<center><button type='button' class='btn btn-primary btn-sm btnEditar' data-toggle='modal' data-target='#modal-lg'> <i class='fas fa-pencil-alt'></i> </button>" +
        ...
        $('.btn-agregar-categorias').on('click', function() {
            accion = "registrar";
        });
        ...
        $('#tablaCategorias tbody').on('click', '.btnEliminar', function() {
            ...
            swal.fire({
                title: "¡CONFIRMAR!",
                text: "Estás seguro que deseas registrar la categoria?",
                icon: 'warning',
        ...
        $(document).on('click', '.btnEditar', function() {
            ...
            $('#modal-actualizar-categoria').modal('show');
        });
        // Evento para limpiar los campos cuando se cierra el modal de edición
        $('#modal-actualizar-categoria').on('hidden.bs.modal', function() {
            $("#idCategoria").val("");
            $("#txtcategoria").val("");
            $("#txtRuta").val("");
                ...
                if (resultado.value) {
                    ...
                    $.ajax({
                        ...
                        success: function(respuesta) {
                            ...
                            $("#modal-actualizar-categoria").modal('hide');
