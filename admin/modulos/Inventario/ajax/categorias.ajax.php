...
class ajaxCategorias {
    ...
    public function RegistrarCategorias() {
        $respuesta = ControladorCategorias::ctrRegistrarCategoria($this->categoria, $this->ruta, $this->estado, $this->fecha);
...
if (!isset($_POST["accion"])) { 
    ...
    $insertar->RegistrarCategorias(); // Llamada al método correcto   
    }

    if($_POST["accion"] == "eliminar") {
        $eliminar = new ajaxCategorias();
        $eliminar->id = $_POST["id"];
        $eliminar->eliminarCategoria(); // Llamada al método correcto   
    }
    ...
    if($_POST["accion"] == "actualizar") {
        ...
        $actualizar->actualizarCategoria(); // Llamada al método correcto   
        }
