...
class ModeloCategorias {
   ...
   static public function mdlMostrarCategorias() {
    ...
    static public function mdlEliminarCategoria($id) {
        ...
        if ($stmt->execute()) {
            return "La categoría se elimino correctamente!";
        } else {
    ...
    static public function mdlActualizarCategoria($id,$categoria,$ruta,$estado,$fecha) {
        ...
        if ($stmt->execute()) {
            return "La categoría se actualizo correctamente!";
        } else {
...
// Instanciar la clase y llamar al método correctamente
/* $categorias = ModeloCategorias::mdlMostrarCategorias();    ESTA PARTE SI VIENE PERO A MI ME CAUSA CONFLICTO Y NO ME MUESTRA LOS DATOS DE LA BASE DE DATOS
print_r($categorias); */
